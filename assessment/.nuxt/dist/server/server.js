...
/******/ 			var chunk = require("./" + ({"1":"pages/contact","2":"pages/finalize","3":"pages/health","4":"pages/index","5":"pages/list"}[chunkId]||chunkId) + ".js");
...
// CONCATENATED MODULE: ./http-common.js

/* harmony default export */ var http_common = (external_axios_default.a.create({
  baseURL: "http://localhost:5000",
  headers: {
    "Content-type": "application/json"
  }
}));
// CONCATENATED MODULE: ./middleware/dataservice.js


class dataservice_DataService {
  getAll() {
    return http_common.get("/getAll");
  }

  get(id) {
    return http_common.get(`/get/${id}`);
  }

  create(data) {
    return http_common.get(`/add/${data.gender}/${data.name}/${data.lastname}/${data.cellphone}/${data.email}/${data.height}/${data.weight}/${data.recentlySick}/`);
  }

  update(id, data) {
    return http_common.put(`/update/${id}`, data);
  }
  ...
  deleteAll() {
    return http_common.delete(`/deleteAll`);
  }

}

/* harmony default export */ var dataservice = __webpack_exports__["default"] = (new dataservice_DataService());
...
const middleware = {};
middleware['dataservice'] = __webpack_require__(15);
...
const _5dde52ce = () => interopDefault(__webpack_require__.e(/* import() | pages/contact */ 1).then(__webpack_require__.bind(null, 40)));

const _90737340 = () => interopDefault(__webpack_require__.e(/* import() | pages/finalize */ 2).then(__webpack_require__.bind(null, 41)));

const _38fec01e = () => interopDefault(__webpack_require__.e(/* import() | pages/health */ 3).then(__webpack_require__.bind(null, 42)));

const _029fbfe0 = () => interopDefault(__webpack_require__.e(/* import() | pages/list */ 5).then(__webpack_require__.bind(null, 43)));

const _6cccbc00 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 4).then(__webpack_require__.bind(null, 44)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(26), 'userInfo.js'); // If the environment supports hot reloading...
})(); // createStore
